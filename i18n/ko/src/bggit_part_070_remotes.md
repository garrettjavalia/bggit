...
*원격 저장소*는 클론하고 푸시하고 풀할 수 있는 원격 서버에 붙인 이름일 뿐입니다.
...
흔한 예는 GitHub 프로젝트를 *포크*한 경우입니다(뒤에서 더 설명합니다). 포크는 다른 사람의 공개 저장소를 자신의 계정으로 쉽게 클론할 수 있게 하는 GitHub 기능이며, 여러분이 만든 변경 사항을 원래 저장소와 편리하게 공유할 방법을 제공합니다.
